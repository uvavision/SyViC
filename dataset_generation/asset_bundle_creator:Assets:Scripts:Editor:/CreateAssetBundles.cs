...
public class CreateAssetBundles
{
    ...
    [MenuItem("Assets/Convert FBX To Humanoid Rig")]
    public static void ConvertFBXToHumanoid()
    {
        // first lets convert FBX to humanoid rig body
        Preset preset = (Preset)AssetDatabase.LoadAssetAtPath("Assets/Presets/FBXImporter.preset", typeof(Preset) );
        Debug.Log(preset);
    }
    ...
    static void ExtractAnimationsFromFBX()
    {
        ...
        foreach(FileInfo file in Files )
        {
            ...
            // first lets convert FBX to humanoid rig body
            Preset preset = (Preset)AssetDatabase.LoadAssetAtPath("Assets/Presets/FBXImporter.preset", typeof(Preset) );
            GameObject target = (GameObject)AssetDatabase.LoadAssetAtPath("Assets/Resources/teach_fbx_101.fbx", typeof(GameObject) );
            ...
            // anim_controller = UnityEditor.Animations.AnimatorController.CreateAnimatorControllerAtPathWithClip("Assets/Resources/Materials/cmu_37_37_01_male.controller", placeClip);
        }
    }
    ...
    static void ClotheTDWPrefabSMPLs()
    {
        ...
        foreach(FileInfo fileMat in FilesMat )
        {
            ...
            // save new asset
            System.IO.Directory.CreateDirectory("My project/Assets/SMPLX_base/PREFABS/" + materialName);
